...
# --- 1. 全局配置 (宏观研报) ---
SAVE_DIRECTORY = "eastmoney_macro_reports"
# API模板 - qType=3 代表宏观研报
API_URL_TEMPLATE = "https://reportapi.eastmoney.com/report/jg?cb=datatable&pageSize={pageSize}&beginTime={beginTime}&endTime={endTime}&pageNo={pageNo}&qType=3&_={timestamp}"
# 详情页模板
DETAIL_PAGE_URL_TEMPLATE = "https://data.eastmoney.com/report/zw_macresearch.jshtml?encodeUrl={encodeUrl}"
...
# --- 4. 主下载函数 ---
def download_macro_reports():
    os.makedirs(SAVE_DIRECTORY, exist_ok=True)
    print(f"所有【宏观研报】将保存在: {os.path.abspath(SAVE_DIRECTORY)}")
    ...
    print(f"\n{'='*20} 所有【宏观研报】下载任务已完成 {'='*20}")

if __name__ == "__main__":
    download_macro_reports()